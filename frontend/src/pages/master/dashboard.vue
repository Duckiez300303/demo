<template>
  <div class="w-screen h-screen flex">
    <!-- Side bar -->
    <div
      class="w-[400px] h-full bg-gray-200 text-white transition-all duration-300 ease-in-out"
      :class="{ '-ml-[400px]': !showSide, 'ml-0': showSide }"
    >
    ...
    <!-- Main -->
    <div class="flex-grow h-full bg-gray-400">
      <div
